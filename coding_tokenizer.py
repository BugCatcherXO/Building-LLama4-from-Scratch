...
#
# This function takes the current word splits (represented as a
#  dictionary where keys are tuples of symbols/characters forming
#  a word and values are their frequencies) and 
#  calculates the frequency of each adjacent pair of symbols across
#  the entire corpus.
#
...
def get_pair_stats(splits):
    ...
    # pairs of symbols.
    # defaultdict: It's like a regular dictionary (dict), 
    ...
    # int: This is the "default factory" you provide when creating 
    # the defaultdict. When a new key is created, it needs a default value, defaultdict 
    # calls this factory function. int() called with no arguments 
    # returns 0.
